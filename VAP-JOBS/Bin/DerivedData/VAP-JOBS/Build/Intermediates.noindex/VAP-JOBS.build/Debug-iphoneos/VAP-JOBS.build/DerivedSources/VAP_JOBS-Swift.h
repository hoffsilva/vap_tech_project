...
SWIFT_MODULE_NAMESPACE_PUSH("VAP_JOBS")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC8VAP_JOBS11AppDelegate")
...
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified alertHeaderView;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
...
@interface JobsListTableView (SWIFT_EXTENSION(VAP_JOBS)) <UISearchControllerDelegate, UISearchResultsUpdating>
